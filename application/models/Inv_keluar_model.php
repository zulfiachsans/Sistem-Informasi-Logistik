...
class Inv_keluar_model extends CI_Model
{
    ...
    public function get_inventory($id = '', $limit = '', $start = '',$created_on='')
    {
        $this->db->select(
            $this->datas_table . ".id, " .
                ...
                $this->datas_table . ".time_of_purchase, " .
                $this->datas_table . ".date_of_sale, " .
                $this->datas_table . ".time_of_sale, " .
                ...
                $this->datas_table . ".updated_on, " .
                $this->datas_table . ".updated_by, " .
        ...
        // if created on provided
        if ($created_on != '') {
            $this->db->like($this->datas_table . '.date_of_sale', $created_on);
        }
        ...
        $this->db->order_by($this->datas_table . '.date_of_sale', 'asc');
        $this->db->order_by($this->datas_table . '.time_of_sale', 'asc');
        $datas = $this->db->get();
        return $datas;
    }
     ...
     *
     */
    public function get_inventory_by_id($id = '', $limit = '', $start = '')
    {
        $this->db->select(
            $this->datas_table . ".id, " .
                $this->datas_table . ".code, " .
     ...
     *
     */
    public function insert_data($agent, $code, $status, $jumlah_datas, $description='')
    {
    ...
    public function update_inventory_by_id($id, $datas)
    {
        // user and datetime
        $datas['updated_by'] = $this->loggedinuser->username;
        $this->db->set('updated_on', 'NOW()', FALSE);
