		...
		<div class="box">
			...
			<div class="box-body" id="edit_data">
				...
				<?php foreach ($data_list->result() as $data) {
					...
					$curr_time_of_purchase = $data->time_of_purchase;
					...
					<form id="input_form" action="<?php echo base_url('inventory/edit/') . $code ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="text" name="date_of_purchase" id="date_of_purchase" class="form-control datepicker" maxlength="10" value="<?php echo $curr_date_of_purchase;  ?>" required>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									echo "error";
									} ?>" value="<?php echo $curr_time_of_purchase; ?>" required>
								</div>
							</div>
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="text" name="satuan_datas" id="satuan_datas" class="form-control" value="<?= $curr_satuan_datas ?>">
									</div>
								</div>
							</div>
