						...
						<form id="input_form" action="<?php echo base_url('inventory/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="text" name="date_of_purchase" id="date_of_purchase" class="form-control datepicker" maxlength="10" required>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" name="time_of_purchase" id="time_of_purchase" class="form-control required" required>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="text" name="satuan_datas" id="satuan_datas" class="form-control">
										</div>
									</div>
								</div>
