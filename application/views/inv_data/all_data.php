				...
				<div class="box-header with-border">
					<h3 class="box-title">Inventory &ensp;
						<a class="btn btn-sm btn-default btn-print" role="button">
							<i class="fa fa-print"></i> Print</a> &ensp;
						<!-- <a class="btn btn-sm btn-default btn-resorting" role="button">
							<i class="fa fa-print"></i> Resorting</a> -->
					</h3>
											...
											<td width="15%" align="center">
												<form action="<?php echo base_url('inventory/delete/' . $data->code) ?>" method="post" autocomplete="off">
													<div class="btn-group-vertical">
														...
														<a class="btn btn-sm btn-default btn-pindahkan" href="#" role="button" data-id="<?= $data->id ?>" data-code="<?= $data->code ?>" data-brand="<?= $data->brand ?>" data-jumlah_datas="<?= $data->jumlah_datas ?>" data-satuan_datas="<?= $data->satuan_datas ?>" data-status="<?= $data->status ?>" data-date_of_purchase="<?= $data->date_of_purchase ?>" data-time_of_purchase="<?= $data->time_of_purchase ?>">
						...
						<form id="input_form" action="<?php echo base_url('inventory/move/') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="agent" class="control-label col-md-3">* Pengambil</label>
									<div class="col-md-9">
	...
	<div class="modal fade" id="printModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="box-body">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<form id="input_form" action="<?php echo base_url('inventory/print/') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							<div class="form-group">
	...
	<!-- Print box -->
	<div class="modal fade" id="resortingModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="box-header with-border">
					<h3 class="box-title">Sorting Data</h3>
					<div class="box-tools pull-right">
						<button class="btn btn-white btn-box-tool" data-dismiss="modal" id="myboxwidget"><i class="fa fa-close"></i></button>
					</div>
				</div>
				<div class="box-body">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<form id="input_form" action="<?php echo base_url('inventory/resorting/') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							<div class="form-group">
								<label for="code" class="control-label col-md-3">Code</label>
								<div class="col-md-9">
									<div class="input-group">
										<input type="text" name="code" id="code" class="form-control" maxlength="5" value="A1-CX" required="required">
									</div>
								</div>
							</div>
							<div class="form-group">
	...
	<script>
		$(document).ready(function() {
			// get Edit Product
			$('.btn-resorting').on('click', function() {
				// Call Modal Edit
				$('#resortingModal').modal('show');
			});
		});
	</script>