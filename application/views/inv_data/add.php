		...
		<div class="box">
			...
			<div class="box-body" id="add_new">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<form id="input_form" action="<?php echo base_url('inventory/add') ?>" method="post"  class="form form-horizontal" enctype="multipart/form-data">
						<h3>Info Dasar</h3>
						<fieldset>
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="text" name="date_of_purchase" id="date_of_purchase" class="form-control datepicker" maxlength="10" value="<?php echo set_value('date_of_purchase') ?>" required>
										<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="time_of_purchase" class="control-label col-md-2">* Jam Masuk</label>
								<div class="col-md-8">
									<input type="text" name="time_of_purchase" id="time_of_purchase" class="form-control required <?php if (form_error('time_of_purchase')) {
									echo "error";
									} ?>" value="<?php echo set_value('time_of_purchase') ?>" required>
								</div>
							</div>
							<div class="form-group">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="number" name="jumlah_datas" id="jumlah_datas" class="form-control" maxlength="12" min="0" value="<?php echo set_value('jumlah_datas') ?>" required>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="satuan_datas" class="control-label col-md-2">* Satuan Data</label>
								<div class="col-md-4">
									<div class="input-group">
										<input type="text" name="satuan_datas" id="satuan_datas" class="form-control" value="<?= set_value('satuan_datas') ?>" required>
									</div>
								</div>
							</div>
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									echo "error";
									} ?>" value="<?php echo set_value('agent') ?>" required>
								</div>
							</div>
							<hr>
							<div class="form-group">
