        ...
        <div class="box">
            ...
            <div class="box-body" id="edit_data">
                ...
                <?php foreach ($data_list->result() as $data) {
                    ...
                    $curr_satuan_datas     = $data->satuan_datas;
                    ...
                    $curr_date_of_sale = $data->date_of_sale;
                    $curr_time_of_sale = $data->time_of_sale;
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <form id="input_form" action="<?php echo base_url('inv_keluar/edit/') . $id ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
                        <h3>Basic Info</h3>
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="date_of_purchase" class="control-label col-md-2">* Tanggal Keluar</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" name="date_of_sale" id="date_of_sale" class="form-control datepicker" maxlength="10" value="<?php echo $curr_date_of_sale ?>" required>
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="time_of_sale" class="control-label col-md-2">* Jam Keluar</label>
                                <div class="col-md-8">
                                    <input type="text" name="time_of_sale" id="time_of_sale" class="form-control required <?php if (form_error('time_of_sale')) {
                                    echo "error";
                                    } ?>" value="<?php echo $curr_time_of_sale ?>" required>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <hr>
                            <div class="form-group">
                                <label for="jumlah_datas" class="control-label col-md-2">* Jumlah Data</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                            ...
                            <div class="form-group">
                                <label for="satuan_datas" class="control-label col-md-2">* Satuan Datas</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" name="satuan_datas" id="satuan_datas" class="form-control" value="<?php echo $curr_satuan_datas ?>">
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="agent" id="agent" class="form-control required <?php if (form_error('agent')) {
                                    echo "error";
                                    } ?>" value="<?php echo $curr_agent ?>" required>
                                </div>
                            </div>
